...
class _AssignmentReportsState extends State<AssignmentReports> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Assignments Reports",style: GoogleFonts.poppins(
            color: Colors.white,
            fontSize: 22,
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                  ...
                  child:TextField(
                    ...
                    onTap: () async {
                      ...
                      if(pickedDate != null ){
                        ...
                        String formattedDate2 = DateFormat('dMyyyy').format(pickedDate);
            ...
            SizedBox(height: 20,),
            view==true?  StreamBuilder(
          stream: _firestore2db.collection("homeworks").doc(currentdate.toString()).
          collection(dropdownValue4.toString()).doc(dropdownValue5.toString()).
          ...
          builder: (context, snapshot2) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return widget.staffreg==subjecthomework['statffregno']? Padding(
                            ...
                            InkWell(
                              onTap: (){
                                Navigator.of(context).push(
                                  MaterialPageRoute(builder: (context)=>SubmittedAssign(currentdate.toString(),dropdownValue4,dropdownValue5,subjecthomework.id))
                                );
